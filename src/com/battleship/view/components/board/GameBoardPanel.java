    ...
    public GameBoardPanel(String title, int size,
        ...
        for (int col = 0; col <= size; col++) {
            ...
            if (col == 0) {
                ...
                empty.setPreferredSize(new Dimension(cellWidth, cellHeight));
                add(empty, gbc);
            } else {
        ...
        for (int row = 1; row <= size; row++) {
            for (int col = 0; col <= size; col++) {
                ...
                if (col == 0) {
                    ...
                    buttons[row - 1][col - 1].setPreferredSize(new Dimension(cellWidth, cellHeight));
                    buttons[row - 1][col - 1].setIcon(normalIcon);
